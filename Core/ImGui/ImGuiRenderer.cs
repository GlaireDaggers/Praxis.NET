...
namespace Praxis.Core.DebugGui
{
    /// <summary>
    ...
    internal class ImGuiRenderer
    {
        ...
        public unsafe ImGuiRenderer(PraxisGame game)
        {
        ...
        protected virtual void UpdateInput()
        {
            ...
            var mouse = _game.CurrentMouseState;
            var keyboard = _game.CurrentKeyboardState;
